...
(cl:defmethod cl:initialize-instance :after ((m <Twist2DStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Twist2DStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mecanum_wheels_msgs-msg:<Twist2DStamped> is deprecated: use mecanum_wheels_msgs-msg:Twist2DStamped instead.")))
...
(cl:defmethod v-val ((m <Twist2DStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecanum_wheels_msgs-msg:v-val is deprecated.  Use mecanum_wheels_msgs-msg:v instead.")
  (v m))

(cl:ensure-generic-function 'omega-val :lambda-list '(m))
(cl:defmethod omega-val ((m <Twist2DStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecanum_wheels_msgs-msg:omega-val is deprecated.  Use mecanum_wheels_msgs-msg:omega instead.")
  (omega m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <Twist2DStamped>))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Twist2DStamped>)))
  ...
  "mecanum_wheels_msgs/Twist2DStamped")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Twist2DStamped)))
  "Returns string type for a message object of type 'Twist2DStamped"
  "mecanum_wheels_msgs/Twist2DStamped")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Twist2DStamped>)))
  ...
  "3215aa23009b2d7176840d48e6499c0e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Twist2DStamped)))
  "Returns md5sum for a message object of type 'Twist2DStamped"
  "3215aa23009b2d7176840d48e6499c0e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Twist2DStamped>)))
  ...
  (cl:format cl:nil "Header header~%float32 v~%float32 omega~%float32 theta~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Twist2DStamped)))
  "Returns full string definition for message of type 'Twist2DStamped"
  (cl:format cl:nil "Header header~%float32 v~%float32 omega~%float32 theta~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
