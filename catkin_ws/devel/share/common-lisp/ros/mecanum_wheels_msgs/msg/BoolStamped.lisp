...
(cl:defmethod cl:initialize-instance :after ((m <BoolStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoolStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mecanum_wheels_msgs-msg:<BoolStamped> is deprecated: use mecanum_wheels_msgs-msg:BoolStamped instead.")))
...
(cl:defmethod data-val ((m <BoolStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecanum_wheels_msgs-msg:data-val is deprecated.  Use mecanum_wheels_msgs-msg:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BoolStamped>)))
  ...
  "mecanum_wheels_msgs/BoolStamped")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BoolStamped)))
  "Returns string type for a message object of type 'BoolStamped"
  "mecanum_wheels_msgs/BoolStamped")
