...
(cl:defmethod cl:initialize-instance :after ((m <SetValue-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetValue-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mecanum_wheels_msgs-srv:<SetValue-request> is deprecated: use mecanum_wheels_msgs-srv:SetValue-request instead.")))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <SetValue-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecanum_wheels_msgs-srv:value-val is deprecated.  Use mecanum_wheels_msgs-srv:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetValue-request>)))
  ...
  "mecanum_wheels_msgs/SetValueRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetValue-request)))
  "Returns string type for a service object of type 'SetValue-request"
  "mecanum_wheels_msgs/SetValueRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetValue-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetValue-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mecanum_wheels_msgs-srv:<SetValue-response> is deprecated: use mecanum_wheels_msgs-srv:SetValue-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetValue-response>)))
  ...
  "mecanum_wheels_msgs/SetValueResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetValue-response)))
  "Returns string type for a service object of type 'SetValue-response"
  "mecanum_wheels_msgs/SetValueResponse")
