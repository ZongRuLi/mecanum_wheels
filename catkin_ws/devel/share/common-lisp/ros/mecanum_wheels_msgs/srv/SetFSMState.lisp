...
(cl:defmethod cl:initialize-instance :after ((m <SetFSMState-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetFSMState-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mecanum_wheels_msgs-srv:<SetFSMState-request> is deprecated: use mecanum_wheels_msgs-srv:SetFSMState-request instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <SetFSMState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecanum_wheels_msgs-srv:state-val is deprecated.  Use mecanum_wheels_msgs-srv:state instead.")
  (state m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetFSMState-request>)))
  ...
  "mecanum_wheels_msgs/SetFSMStateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetFSMState-request)))
  "Returns string type for a service object of type 'SetFSMState-request"
  "mecanum_wheels_msgs/SetFSMStateRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetFSMState-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetFSMState-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mecanum_wheels_msgs-srv:<SetFSMState-response> is deprecated: use mecanum_wheels_msgs-srv:SetFSMState-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetFSMState-response>)))
  ...
  "mecanum_wheels_msgs/SetFSMStateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetFSMState-response)))
  "Returns string type for a service object of type 'SetFSMState-response"
  "mecanum_wheels_msgs/SetFSMStateResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetFSMState)))
  ...
  "mecanum_wheels_msgs/SetFSMState")