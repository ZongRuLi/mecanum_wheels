...
(cl:defmethod cl:initialize-instance :after ((m <SetVariable-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetVariable-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mecanum_wheels_msgs-srv:<SetVariable-request> is deprecated: use mecanum_wheels_msgs-srv:SetVariable-request instead.")))

(cl:ensure-generic-function 'name_json-val :lambda-list '(m))
(cl:defmethod name_json-val ((m <SetVariable-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecanum_wheels_msgs-srv:name_json-val is deprecated.  Use mecanum_wheels_msgs-srv:name_json instead.")
  (name_json m))

(cl:ensure-generic-function 'value_json-val :lambda-list '(m))
(cl:defmethod value_json-val ((m <SetVariable-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecanum_wheels_msgs-srv:value_json-val is deprecated.  Use mecanum_wheels_msgs-srv:value_json instead.")
  (value_json m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetVariable-request>)))
  ...
  "mecanum_wheels_msgs/SetVariableRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetVariable-request)))
  "Returns string type for a service object of type 'SetVariable-request"
  "mecanum_wheels_msgs/SetVariableRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetVariable-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetVariable-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mecanum_wheels_msgs-srv:<SetVariable-response> is deprecated: use mecanum_wheels_msgs-srv:SetVariable-response instead.")))

(cl:ensure-generic-function 'success_json-val :lambda-list '(m))
(cl:defmethod success_json-val ((m <SetVariable-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecanum_wheels_msgs-srv:success_json-val is deprecated.  Use mecanum_wheels_msgs-srv:success_json instead.")
  (success_json m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetVariable-response>)))
  ...
  "mecanum_wheels_msgs/SetVariableResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetVariable-response)))
  "Returns string type for a service object of type 'SetVariable-response"
  "mecanum_wheels_msgs/SetVariableResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetVariable)))
  ...
  "mecanum_wheels_msgs/SetVariable")