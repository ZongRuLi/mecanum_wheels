...
// (in-package mecanum_wheels_msgs.srv)
...
class GetVariableRequest {
  ...
  static datatype() {
    ...
    return 'mecanum_wheels_msgs/GetVariableRequest';
  }
...
class GetVariableResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'mecanum_wheels_msgs/GetVariableResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'mecanum_wheels_msgs/GetVariable'; }
};
